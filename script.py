...
from engine_logic.scene import Scene
from engine_logic.objects import Circle, Text
from engine_logic.animations import FadeIn, Move, FadeOut

# Create a simple animation
def main():
    anim = Scene(width=1280, height=720, duration=5, fps=30)
